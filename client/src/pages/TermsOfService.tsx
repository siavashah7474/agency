            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  By accessing or using Webimot's website and services, you
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Webimot provides digital marketing, automation, and consulting
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
                  ...
                  <li>
                    Grant necessary access to accounts and platforms as required
                    for services
                  </li>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  and software, is the property of Webimot or its content
                  suppliers and is protected by intellectual property laws.
                  Deliverables created specifically for clients become client
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  proprietary or sensitive information shared during the course
                  of the business relationship. This includes but is not limited
                  to business strategies, customer data, and financial
                  information.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Webimot shall not be liable for any indirect, incidental,
                  special, consequential, or punitive damages, including loss of
                  profits, data, or business opportunities. Our total liability
                  shall not exceed the amount paid for services in the 12 months
                  preceding the claim.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  While we strive to deliver excellent results, we cannot
                  guarantee specific outcomes such as search rankings, lead
                  volumes, or conversion rates. Marketing results depend on many
                  factors outside our control including market conditions,
                  competition, and client responsiveness.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  notice unless otherwise specified in the service agreement.
                  Upon termination:
                </p>
                <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Our services often integrate with third-party platforms (Meta,
                  Google, WhatsApp, etc.). We are not responsible for changes to
                  these platforms' policies, pricing, or availability. Clients
                  must maintain their own accounts and comply with all platform
                  terms.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  negotiation. If resolution cannot be reached, disputes shall
                  be subject to the laws and courts of Turkey.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  acceptance of the new terms. We will make reasonable efforts
                  to notify clients of significant changes.
                </p>
              </section>
