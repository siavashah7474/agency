            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Webimot ("we," "our," or "us") respects your privacy and is
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
                  <li>
                    ...
                    phone number, company name when you fill out forms or
                    contact us.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    correspondence when you contact us via email, WhatsApp, or
                    contact forms.
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
                  <li>
                    ...
                    that help us operate our business (hosting, analytics, email
                    services).
                  </li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  user behavior. You can control cookies through your browser
                  settings.
                </p>
              </section>
