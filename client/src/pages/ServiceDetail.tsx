...
import { Check, MessageSquare, FileText, BarChart, Target, TrendingUp, Globe, Zap, Users, Award, Megaphone, PenTool, ArrowRight, Sparkles, Package, ListChecks, HelpCircle, ImageIcon, Phone, Calendar, CheckCircle2 } from "lucide-react";
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Every Business is Unique</h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  We don't believe in one-size-fits-all solutions. Book a free strategy call and we'll create a custom plan tailored to your specific needs and goals.
                </p>
              </div>
              ...
              <Card className="bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20">
                <CardContent className="p-8 md:p-12">
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      <h3 className="text-2xl font-bold mb-4">What You'll Get in Your Free Strategy Call</h3>
                      <ul className="space-y-3">
                        <li className="flex items-start gap-3">
                          <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                          <span>Personalized assessment of your current situation</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                          <span>Custom recommendations tailored to your business</span>
                        </li>
                        <li className="flex items-start gap-3">
                          <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                        ...
                        <li className="flex items-start gap-3">
                          <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                          <span>Honest advice - no pressure, no obligations</span>
                        </li>
                      </ul>
                    </div>
                    <div className="text-center">
                      <div className="bg-white dark:bg-muted rounded-2xl p-6 shadow-lg">
                        ...
                        <h4 className="text-xl font-bold mb-2">Book Your Free Call</h4>
                        <p className="text-sm text-muted-foreground mb-6">20-minute strategy session with our experts</p>
                        <Link href="/book-consultation">
                          <Button data-testid="button-book-strategy-section" size="lg" className="w-full mb-3">
                            Schedule Now
                            <ArrowRight className="ml-2 h-4 w-4" />
                          </Button>
                        </Link>
                        <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer">
                          <Button data-testid="button-whatsapp-strategy-section" variant="outline" size="lg" className="w-full">
